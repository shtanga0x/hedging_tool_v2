...
export const API_CONFIG = {
  ...
  // Deribit is not proxied: candles use a direct WebSocket and DVOL/instruments
  // are CORS-enabled, so the client calls www.deribit.com directly (see deribit.ts).
};
